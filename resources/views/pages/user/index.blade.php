            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="javascript:void(0)" class="btn btn-xs text-white" style="background-color: #5e63b6 !important;"
                        id="btnTambah">
                        <i class="fas fa-sm fa-plus text-white text-xs opacity-10 px-1"></i> Add User
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <div class="modal-body">
                    <form action="#" id="form-store" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <span id="role_error" class="text-danger error-text my-2 text-sm"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" placeholder="Typing email">
                            <span id="name_error" class="text-danger error-text my-2 text-sm"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password" class="form-control" placeholder="Typing password">
                            <span id="name_error" class="text-danger error-text my-2 text-sm"></span>
                        </div>
...
@push('script')
    ...
    <script>
        ...
        $jquery('#tambahModal').on('hidden.bs.modal', function(event) {
            ...
            $jquery("#role").val('').trigger('change')
